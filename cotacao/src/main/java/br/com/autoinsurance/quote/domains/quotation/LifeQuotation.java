...
public class LifeQuotation implements IQuotation {

    private static String EMAIL_MESSAGE = "Não estamos atendendo cotações de vida no momento. Guardaremos seus dados e entraremos em contato no futuro";
    @Override
    public InsuranceQuote getQuote(InsuranceQuoteDTO dto) {
        InsuranceQuote insuranceQuote = new InsuranceQuote(dto);
        insuranceQuote.setType(QuotationTypes.LIFE);
